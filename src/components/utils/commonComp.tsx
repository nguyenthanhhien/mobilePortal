...
const ErrorMessage = ({ inputText }: any) => {
    return (
        <p className="error-message">{inputText}</p>
    )
}

const ToastTemplate = ({ toastType, text }: any) => {
    return (
        <div>
...
function PresentToast(textInput: string, toastType: any, autoClose = 10000) {
    toast(<ToastTemplate toastType={toastType} text={textInput} />, { type: toastType, autoClose: autoClose })
}
